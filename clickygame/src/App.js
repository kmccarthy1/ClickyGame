  ...
  render() {
    return (
      <div className="App">
        ...
        <footer>
          <p>Designed and built by Kevin McCathy. You can find the
          code<a href="https://github.com/kmccarthy1/ClickyGame" target="_blank" rel="noopener noreferrer"> here</a>.</p>
        </footer>
    </div>
    );
  }
